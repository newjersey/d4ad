...
import {buildAddress, buildOccupation, buildProvider, buildTraining} from "../test-objects/factories";
...
describe("<TrainingPage />", () => {
  ...
  it("displays helper text if training has no occupations or NO MATCH", () => {
    ...
    act(() => stubClient.capturedObserver.onSuccess(buildTraining({ occupations: [buildOccupation({title: "NO MATCH"})] })));
