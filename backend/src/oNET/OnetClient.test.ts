...
describe("OnetClient", () => {
  ...
  beforeEach(() => {
    ...
    getOccupationDetailPartial = OnetClient("wwww.some-cool-url.com", mockedAuth, mockConvert2010SocTo2018Soc);
  });
  ...
  it("sends request and gets response with description, tasks, and related occupations", async () => {
    ...
    mockConvert2010SocTo2018Soc
      .mockResolvedValueOnce(buildOccupation({ soc: "11-9021 (2018)", title: "Construction Managers 2018" }))
      .mockResolvedValueOnce(buildOccupation({ soc: "11-9041 (2018)", title: "Architectural and Engineering Managers 2018" }))
